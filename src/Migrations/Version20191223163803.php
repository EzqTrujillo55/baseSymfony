 ...
 */
final class Version20191223163803 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE empresa empresa BIGINT DEFAULT NULL, CHANGE config config BIGINT UNSIGNED DEFAULT NULL, CHANGE salt salt VARCHAR(255) DEFAULT NULL, CHANGE last_login last_login DATETIME DEFAULT NULL, CHANGE confirmation_token confirmation_token VARCHAR(180) DEFAULT NULL, CHANGE password_requested_at password_requested_at DATETIME DEFAULT NULL, CHANGE empleado empleado BIGINT DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649D9D9BF52 FOREIGN KEY (empleado) REFERENCES gc_empleado_carga (mc_id)');
        $this->addSql('CREATE INDEX IDX_8D93D649D9D9BF52 ON user (empleado)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE materia CHANGE registro_id registro_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE matricula CHANGE estudiante_id estudiante_id INT DEFAULT NULL, CHANGE materia_id materia_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D649D9D9BF52');
        $this->addSql('DROP INDEX IDX_8D93D649D9D9BF52 ON user');
        $this->addSql('ALTER TABLE user CHANGE empresa empresa BIGINT DEFAULT NULL, CHANGE config config BIGINT UNSIGNED DEFAULT NULL, CHANGE empleado empleado BIGINT DEFAULT NULL, CHANGE salt salt VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE last_login last_login DATETIME DEFAULT \'NULL\', CHANGE confirmation_token confirmation_token VARCHAR(180) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE password_requested_at password_requested_at DATETIME DEFAULT \'NULL\'');
    }
}
