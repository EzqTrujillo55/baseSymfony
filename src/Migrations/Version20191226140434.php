...
final class Version20191226140434 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE us_caducar_intento (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD us_caducar_intento VARCHAR(1) NOT NULL, ADD us_consulta_otros_datos_pv VARCHAR(1) NOT NULL, ADD us_cierre_caja_pv VARCHAR(1) NOT NULL, ADD us_documentos_electronicos_manejo TINYINT(1) NOT NULL, CHANGE empresa empresa BIGINT DEFAULT NULL, CHANGE perfil perfil BIGINT UNSIGNED DEFAULT NULL, CHANGE salt salt VARCHAR(255) DEFAULT NULL, CHANGE last_login last_login DATETIME DEFAULT NULL, CHANGE confirmation_token confirmation_token VARCHAR(180) DEFAULT NULL, CHANGE password_requested_at password_requested_at DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE us_caducar_intento');
        ...
        $this->addSql('ALTER TABLE materia CHANGE registro_id registro_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE matricula CHANGE estudiante_id estudiante_id INT DEFAULT NULL, CHANGE materia_id materia_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user DROP us_caducar_intento, DROP us_consulta_otros_datos_pv, DROP us_cierre_caja_pv, DROP us_documentos_electronicos_manejo, CHANGE empresa empresa BIGINT DEFAULT NULL, CHANGE perfil perfil BIGINT UNSIGNED DEFAULT NULL, CHANGE salt salt VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE last_login last_login DATETIME DEFAULT \'NULL\', CHANGE confirmation_token confirmation_token VARCHAR(180) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE password_requested_at password_requested_at DATETIME DEFAULT \'NULL\'');
    }
}
