 ...
 */
final class Version20191226143033 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE empresa empresa BIGINT DEFAULT NULL, CHANGE perfil perfil BIGINT UNSIGNED DEFAULT NULL, CHANGE salt salt VARCHAR(255) DEFAULT NULL, CHANGE last_login last_login DATETIME DEFAULT NULL, CHANGE confirmation_token confirmation_token VARCHAR(180) DEFAULT NULL, CHANGE password_requested_at password_requested_at DATETIME DEFAULT NULL, CHANGE us_caducar_intento us_caducar_intento TINYINT(1) NOT NULL, CHANGE us_consulta_otros_datos_pv us_consulta_otros_datos_pv TINYINT(1) NOT NULL, CHANGE us_cierre_caja_pv us_cierre_caja_pv TINYINT(1) NOT NULL');
    }
