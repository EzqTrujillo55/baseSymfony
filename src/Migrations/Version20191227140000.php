 ...
 */
final class Version20191227140000 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gc_empresa CHANGE em_fecha_contrato em_fecha_contrato DATE DEFAULT NULL, CHANGE em_fecha_ultimo_pago em_fecha_ultimo_pago DATE DEFAULT NULL, CHANGE em_docs_elec_fecha_caduca em_docs_elec_fecha_caduca DATE DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD us_transacciona VARCHAR(1) DEFAULT NULL, CHANGE empresa empresa BIGINT DEFAULT NULL, CHANGE perfil perfil BIGINT UNSIGNED DEFAULT NULL, CHANGE salt salt VARCHAR(255) DEFAULT NULL, CHANGE last_login last_login DATETIME DEFAULT NULL, CHANGE confirmation_token confirmation_token VARCHAR(180) DEFAULT NULL, CHANGE password_requested_at password_requested_at DATETIME DEFAULT NULL');
    }
