 ...
 */
final class Version20191223163501 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD empleado BIGINT DEFAULT NULL, CHANGE empresa empresa BIGINT DEFAULT NULL, CHANGE config config BIGINT UNSIGNED DEFAULT NULL, CHANGE salt salt VARCHAR(255) DEFAULT NULL, CHANGE last_login last_login DATETIME DEFAULT NULL, CHANGE confirmation_token confirmation_token VARCHAR(180) DEFAULT NULL, CHANGE password_requested_at password_requested_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649D9D9BF52 FOREIGN KEY (empleado) REFERENCES gc_empleado_carga (mp_id)');
